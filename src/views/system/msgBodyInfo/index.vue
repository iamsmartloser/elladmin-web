  ...
  <div class="app-container">
    ...
    <div class="head-container">
      <div v-if="crud.props.searchToggle">
        ...
        <el-input v-model="query.type" clearable placeholder="消息类型" style="width: 185px;" class="filter-item" @keyup.enter.native="crud.toQuery" />
        <label class="el-form-item-label">允许回复:</label>
        <el-input v-model="query.allowReceive" clearable placeholder="允许回复" style="width: 185px;" class="filter-item" @keyup.enter.native="crud.toQuery" />
        <label class="el-form-item-label">是否强提醒:</label>
        <el-input v-model="query.compulsaryWarningType" clearable placeholder="是否强提醒" style="width: 185px;" class="filter-item" @keyup.enter.native="crud.toQuery" />
        <label class="el-form-item-label">消息标题:</label>
        <el-input v-model="query.title" clearable placeholder="消息标题" style="width: 185px;" class="filter-item" @keyup.enter.native="crud.toQuery" />
        <label class="el-form-item-label">发送者姓名:</label>
        <el-input v-model="query.createUserName" clearable placeholder="发送者姓名" style="width: 185px;" class="filter-item" @keyup.enter.native="crud.toQuery" />
        <date-range-picker
      ...
      <el-dialog :close-on-click-modal="false" :before-close="crud.cancelCU" :visible.sync="crud.status.cu > 0" :title="crud.status.title" width="500px">
        <el-form ref="form" :model="form" :rules="rules" size="small" label-width="80px">
          <el-form-item label="ID" v-if="crud.status.edit" v-show="false" >
